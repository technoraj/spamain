...
function show1(){
	$("#choice-mouscron").click(function(){
		$("#mouscron").fadeIn("slower");
		$("#tournai").css('display', 'none');
	});
}
function show2(){
	$("#choice-tournai").click(function(){
		$("#tournai").fadeIn("slower");
		$("#mouscron").css('display', 'none');
	});
}
